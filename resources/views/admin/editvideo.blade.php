...
<div class="flex w-[70%] m-auto gap-[40px] h-[70vh] items-center">
    <div class="w-[50%]">
        <div class="w-[100%] h-[500px] m-auto"> {!! $video->video_html_code !!}</div>
        <div class="w-[100%] m-auto text-[25px]">
    ...
    <div class="w-[50%] relative top-[-210px]">
        <form action="{{route("admin.updateVideo", ["id" => $video->id])}}" method="POST" class="flex flex-col p-[10px]">
            @csrf
